...
class Invoice(SQLModel, table=True):
    ...
    interactions: List["MadooInteraction"] = Relationship(back_populates="invoice" , lazy="selectin")
...
class MadooInteraction(SQLModel, table=True):
    ...
    invoice: Optional[Invoice] = Relationship(back_populates="interactions",lazy="selectin")
